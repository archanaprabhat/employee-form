    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white border-b border-gray-200">
        <div className="px-6 py-3 flex items-center justify-between">
          <div className="flex items-center space-x-2">
            <span className="text-gray-600 text-sm">Employee Master</span>
      ...
      <div className="bg-blue-50 border-b border-blue-100">
        <div className="px-6 py-3">
          <h1 className="text-gray-900 font-medium">Employee Creation</h1>
        </div>
      </div>
      ...
      <div className="bg-white border-b border-gray-200">
        <div className="px-6">
          <div className="flex space-x-8">
            <button className="py-4 text-blue-600 border-b-2 border-blue-600 font-medium text-sm">
              Employee Details
            </button>
            <button className="py-4 text-gray-500 text-sm hover:text-gray-700">
              Address
            </button>
            <button className="py-4 text-gray-500 text-sm hover:text-gray-700">
              Skill Set
